...
root.title("Sanjana Password Generator")
...
Title = Label(root, text=" Password Generator", bg="beige", fg="black", font=("times", 15, "bold"))
Title.pack(anchor="center", pady="20px")

length = Label(root, text="Length of Your Password :- ", fg="darkgreen", bg="beige", font=("ubuntu", 12))
...
Selector.current(7)
Selector.place(x="200px", y="70px")

generate_btn = Button(root, text="Generate Password", bg="plum", fg="black", font=("ubuntu", 15), cursor="hand2", command=password_generate)
